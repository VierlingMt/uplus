...
-- ---------------------------------------------------------------------------
-- Login-Codes (passwortloser Login per SMS-Einmalcode, Alternative zum
-- Magic-Link). Gespeichert wird nur der SHA-256-Hash des 6-stelligen Codes;
-- Fehlversuche werden gezählt (Schutz gegen Erraten).
-- ---------------------------------------------------------------------------
